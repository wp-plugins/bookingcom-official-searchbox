(function(c, a) {
	...
	b.validation = {
		...
		checkDestination: function() {
			...
			this.showFormError(b.vars.errors.destinationErrorMsg, "searchBox_error_msg");
			return false;
		},
		checkDates: function() {
			var j = b.gElm,
			...
			if (parseInt(i[1]) === parseInt(o[1]) && k < parseInt(o[2])) {
				this.showFormError(b.vars.errors.dateInThePast, "searchBox_dates_error_msg");
				return false;
			}
			...
			if ((n - g) / (1000 * 60 * 60 * 24) > 30) {
				this.showFormError(b.vars.errors.tooManyDays, "searchBox_dates_error_msg");
				return false;
			}
			return true;
		},
...
jQuery("#b_dest_unlocker").click(function(event) {
