...
sp.variables = {
	...
	calendar_url: '',
	months: [objectL10n.january, objectL10n.february, objectL10n.march, objectL10n.april, objectL10n.may, objectL10n.june, objectL10n.july, objectL10n.august, objectL10n.september, objectL10n.october, objectL10n.november, objectL10n.december],
	days: [objectL10n.mo, objectL10n.tu, objectL10n.we, objectL10n.th, objectL10n.fr, objectL10n.sa, objectL10n.su],
	b_is_searchbox: true
};
...
function buildCal(y, m, d) {
	...
	if (filaMonth == 0) {
		...
		t += '<a class="changeMonth" href="javascript:prevMonth(' + y + ',' + m + ');" title="' + sp.variables.calendar_Month + '">&nbsp;&lt;&nbsp;</a>';
	}
	if (!sp.variables.b_hide_month_dd) {
		t += '&nbsp;<select name="ym" class="selectMonth" onchange="goMonth(this.options[this.selectedIndex].value)">';
	...
	if (filaMonth == 11) {
		...
		t += '<a class="changeMonth" href="javascript:nextMonth(' + y + ',' + m + ');" title="' + sp.variables.calendar_nextMonth + '">&nbsp;&gt;&nbsp;</a>';
	}
	t += '</td></tr>';
	...
	for (i = 1; i <= 42; i++) {
		...
		t += '<td class="' + cl + '">';
		if (href) {
			t += '<a id="' + x + '-' + m + '-' + y + '" class="calDateClick" href="javascript:pickDate(' + y + ',' + m + ',' + x + ',\'' + dt + '\',\'' + frm + '\');">' + x + '</a>';
		} else {
			t += x;
		}
		t += '</td>';
	...
	t += '</tr><tr class="b_calClose"><td colspan="7"><a href="javascript:closeCal();">' + sp.variables.calendar_closeCalendar + '</a></td></tr></table>';
...
function tickCheckBox(a) {
	...
	(function(d) {
		var checkIn,
			...
			updateTextInput = function(e) {
				...
				if (!elm.className.match(/changeMonth|selectMonth/)) {
					...
					pickDate(splitDates[2], splitDates[1], splitDates[0], "b_" + e.currentTarget.className.split("_")[1], "b_frm");
				}
			};
        ...
        if(  frm &&  frm.length > 0 && frm != null ) {
            ...
            if ((frm.checkin_monthday.selectedIndex == 0) && (frm.checkout_monthday.selectedIndex == 0)) {
