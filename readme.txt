...
* Choose http or https protocol for landing pages
* Preset specific destination: now destination type and ID available to make guests searches more accurate
...
Multiple search boxes in different widget areas in the same page would affect the functionalities. Thanks to Meta Boxes feature you can use same widget to display different destination for each post and page.
