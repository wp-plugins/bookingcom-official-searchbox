...
<div id="flexi_searchbox" style="<?php echo  $bgcolor ? 'background-color:'. $bgcolor .';' : ''; echo  $textcolor ? 'color:'. $textcolor .';' : '' ; echo $widget_width ? 'width:'. $widget_width . 'px;' : '' ; ?>" data-ver="<?php echo BOS_PLUGIN_VERSION ; ?>" >
    ...
    <div id="b_searchboxInc">
        <h3 class="search-box-title-1"  style="<?php echo  $textcolor ? 'color:' . $textcolor . ';' : '' ; ?>"><?php echo $maintitle ; ?></h3>
         <form id="b_frm" action="<?php echo $target_page ; ?>" method="get" target="_blank" onsubmit="return sp.validation.validSearch();">
            ...
            <div id="b_frmInner">
                ...
                <div id="b_searchDest">
                    <h4 id="b_destination_h4" style="<?php echo  $textcolor ? 'color:' . $textcolor . ';' : '' ; ?>"><?php echo $dest_title ; ?></h4>
                ...
                <div class="b_submitButton_wrapper" style="<?php  echo $buttonpos ? 'text-align:' . $buttonpos : '' ; ?>">
