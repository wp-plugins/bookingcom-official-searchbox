...
function bos_create_searchbox( $searchbox_options, $preview ) {
    ...
    // Set variables for teh searchbox: if none the default values will be used
    ...
    $target_page = 'http://www.booking.com/searchresults.html' ;
    
    // Set the default aid if no aid provided
    $aid = !empty( $options[ 'aid' ] ) ? $options[ 'aid' ] : BOS_DEFAULT_AID ;
