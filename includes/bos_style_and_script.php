...
function bos_searchbox_add_styles() {
    ...
    wp_register_style( 'bos_settings_css', BOS_CSS_PLUGIN_DIR . '/bos_settings.css' ) ;
    wp_register_style( 'bos_sb_main_css', BOS_CSS_PLUGIN_DIR . '/bos_searchbox.css' ) ;
}
...
function bos_searchbox_add_scripts() {
    ...
    wp_register_script( 'bos_main_js', BOS_JS_PLUGIN_DIR . '/bos_main.js', '', '', true ) ;
    wp_register_script( 'bos_date_js', BOS_JS_PLUGIN_DIR . '/bos_date.js', '', '', true ) ;
    wp_register_script( 'bos_general_js', BOS_JS_PLUGIN_DIR . '/bos_general.js', '', '', true ) ;    
